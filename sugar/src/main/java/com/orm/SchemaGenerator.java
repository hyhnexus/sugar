...
public class SchemaGenerator {
    ...
    private SchemaGenerator(Class<?>[] classes) {
        this.mClasses = classes;
    }

    public static SchemaGenerator getInstance(Class<?>[] classes) {
        return new SchemaGenerator(classes);
    }

    public void createDatabase(SQLiteDatabase sqLiteDatabase) {
//        List<Class> domainClasses = getDomainClasses();
        for (Class domain : mClasses) {
...
//                }
    ...
    protected String createTableSQL(Class<?> table) {
        ...
        Log.i(SUGAR, createTableStatement);
